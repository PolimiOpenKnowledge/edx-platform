...
########################## Course Discovery #######################
COURSE_DISCOVERY_FILTERS = ENV_TOKENS.get("COURSE_DISCOVERY_FILTERS", DEFAULT_COURSE_DISCOVERY_FILTERS)
COURSE_DISCOVERY_MEANINGS = ENV_TOKENS.get("COURSE_DISCOVERY_MEANINGS", DEFAULT_COURSE_DISCOVERY_MEANINGS)
